...
AccelStepper stepper1(motorPin1, motorPin3, motorPin2, motorPin4);//x-direction
AccelStepper stepper2(motorPin5, motorPin7, motorPin6, motorPin8);//y-direction
...
for (i=1; i<=5; i++) {
  ...
  stepper2.move(5); //<<need to check direction + or -
